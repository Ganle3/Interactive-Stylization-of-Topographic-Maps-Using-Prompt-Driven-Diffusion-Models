...
OUTDIR  = r"D:\Junyhuang\Project2\Outputs_overfit\one seg\adapter_deeper_lora_of"
...
viz_seg    = one["seg"].unsqueeze(0)  # [1,C,H,W]
viz_gt     = one["gt"].unsqueeze(0)
viz_prompt = [one["prompt"]]
...
while global_step < STEPS:
    for batch in dl:
        ...
        if global_step % 200 == 0:
            ...
            prompts_for_check = viz_prompt  # 比如 ["your prompt..."]
