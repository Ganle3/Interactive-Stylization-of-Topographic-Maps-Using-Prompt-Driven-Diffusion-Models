# one seg but targets: different objects change to same color (light green)
# -*- coding: utf-8 -*-
...
ROOTDIR = r"D:\Junyhuang\Project2_Data\Training Data\Multiobject_lightgreen"
JSONL   = os.path.join(ROOTDIR, "meta", "pairs.jsonl")
SPLIT_DIR = os.path.join(ROOTDIR, "meta_overfit_test_sample")
OUTDIR  = r"D:\Junyhuang\Project2\Outputs_overfit\one seg\multi_classes_adapter_lora12_of"
...
# sanity check
print("[base] len:", len(ds_base))  # 应该是 5

REPEAT = 200            # 5 × 200 = 1000 条
