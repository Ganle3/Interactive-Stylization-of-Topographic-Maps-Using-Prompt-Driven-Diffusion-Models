...
OUTDIR  = r"D:\Junyhuang\Project2\Outputs_overfit\Sameseg_multiprompt\batch_switch\expand_prompts\gen_test_5000"
...
# --- 注入 LoRA (与训练保持一致) ---
from textenc_utils import LoRALinear, lora_kv, ensure_lora_to_device  # 复用原脚本里的函数
wrapped = lora_kv(model.model.diffusion_model, r=12)  # 与训练一致的秩
print("LoRA-wrapped linears:", wrapped)

# --- 加载15000步的LoRA参数 ---
LORA_PT = r"D:\Junyhuang\Project2\Outputs_overfit\Sameseg_multiprompt\batch_switch\expand_prompts\unet_lora_step024000.pt"
...
print(f"[load] LoRA weights: missing={len(missing)}, unexpected={len(unexpected)}")
...
# 然后直接加载整个权重
ckpt_path = r"D:\Junyhuang\Project2\Outputs_overfit\Sameseg_multiprompt\batch_switch\expand_prompts\textenc_adapter_step024000.pt"
...
seg_paths = [
    ...
    r"D:\Junyhuang\Project2_Data\Training Data\Item_color\source\building_pink_000562.png",
    r"D:\Junyhuang\Project2_Data\Training Data\Item_color\source\building_pink_000562.png",
    r"D:\Junyhuang\Project2_Data\Training Data\Building_color\source\building_gray_001873.png",
    r"D:\Junyhuang\Project2_Data\Training Data\Building_color\source\building_gray_001872.png",
    r"D:\Junyhuang\Project2_Data\Training Data\Item_color\source\building_pink_000510.png",
    r"D:\Junyhuang\Project2_Data\Training Data\Item_color\source\building_pink_000510.png",
]
...
prompts = [
    ...
    "Set Stream color to light blue.",
    "Set Stream color to dark blue.",
    "Keep original color.",
    "Set Highway color to light green.",
    "Set Lake color to dark blue.",
