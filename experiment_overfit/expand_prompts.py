# multi seg multi targets: stream (light/dark blue), buildings (gray, brown), Highway (light green), river (light blue), lake (dark blue) in diff tile
# -*- coding: utf-8 -*-
...
ROOTDIR = r"D:\Junyhuang\Project2_Data\Training Data\Sameseg_diffitem_8_expand"
JSONL   = os.path.join(ROOTDIR, "meta", "pairs_seggroup.jsonl")
SPLIT_DIR = os.path.join(ROOTDIR, "meta_overfit_test_sample")
OUTDIR  = r"D:\Junyhuang\Project2\Outputs_overfit\Sameseg_multiprompt\batch_switch\expand_prompts"
...
ADAPTER_PT = r"D:\Junyhuang\Project2\Outputs_overfit\Sameseg_multiprompt\batch_switch\expand_prompts\textenc_adapter_step005000.pt"
LORA_PT    = r"D:\Junyhuang\Project2\Outputs_overfit\Sameseg_multiprompt\batch_switch\expand_prompts\unet_lora_step005000.pt"
