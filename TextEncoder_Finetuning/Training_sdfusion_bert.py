...
OUTDIR  = r"D:\Junyhuang\Project2\Outputs\sdfusion_bert_lastlayer_interout_color"
...
def build_text_encoder(n_embed=768, n_layer=12, max_len=77, device="cuda", use_tokenizer=True):
    ...
    def encode_on_device(prompts):
        enc = tokenizer(
            prompts, return_tensors='pt', padding="max_length", truncation=True, max_length=max_len  # 固定到 77
        )
