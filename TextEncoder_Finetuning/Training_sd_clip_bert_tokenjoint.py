...
from token_utils import build_cond_uc_safe, BertAlign
...
OUTDIR  = r"D:\Junyhuang\Project2\Outputs\sdfusion_bert_ll_ofsp_color\adpter_LoRA_joint_tokens"
LOSS_LOG_PATH = os.path.join(OUTDIR, "vis", "loss_log.json")
os.makedirs(os.path.join(OUTDIR, "vis"), exist_ok=True)

# Training hyperparameters
BATCH=8; SIZE=512; STEPS=2100; MAXLEN=24
USE_LORA = True
        ...
        if global_step % VAL_EVERY == 0:
            ...
            if global_step % SAVE_IMG_EVERY == 0:
                ...
                preds_a = sample_preview_new(
                    ...
                    device, steps=20, scale=5.5, eta=0.0, seed=1234
                )
