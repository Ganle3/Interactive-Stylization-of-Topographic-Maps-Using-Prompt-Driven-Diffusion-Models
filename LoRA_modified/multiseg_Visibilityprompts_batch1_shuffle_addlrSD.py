...
ROOTDIR = r"D:\Junyhuang\Project2_Data\Training Data\PromptCate_SS\Visibility"
JSONL   = os.path.join(ROOTDIR, "meta", "pairs.jsonl")
SPLIT_DIR = os.path.join(ROOTDIR, "meta_split")
OUTDIR  = r"D:\Junyhuang\Project2\Outputs_Visibilityprompts_final"
...
param_groups = [
    {"params": adapter_params,       "lr": 1e-5},   # BERT adapter
    {"params": unet_lora_params,     "lr": 1e-5},   # main UNet Q/K/V LoRA
    {"params": main_ctrl_params,     "lr": 1e-5},   # ctrlora norm+zero+local lora
]
...
split_paths = stratified_split_ratio(
    JSONL, SPLIT_DIR, per_prompt_ratio=(0.98, 0.0, 0.02),
    min_per_split=(1, 0, 1), shuffle_seed=42, verbose=True
)  #  → 4900, 0, 100
...
ds_val = Subset(ds_base, [0, 649, 1218, 1527, 1836, 2545, 3854, 5263])
