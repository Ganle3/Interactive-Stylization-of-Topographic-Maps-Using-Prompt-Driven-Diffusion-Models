...
BATCH=1; SIZE=512; STEPS=15000; MAXLEN=77
...
ADAPTER_CKPT = r"D:\Junyhuang\Project2\Outputs_19prompts_color_ctrlora_Unetlora_deepertext\textenc_adapter_step100000.pt"
CTRLNET_LORA_CKPT = r"D:\Junyhuang\Project2\Outputs_19prompts_color_ctrlora_Unetlora_deepertext\ctrlora_ft_step100000.ckpt"
UNET_LORA_CKPT    = r"D:\Junyhuang\Project2\Outputs_19prompts_color_ctrlora_Unetlora_deepertext\unet_lora_step100000.ckpt"
...
ds_val = Subset(ds_base, [0, 349, 618, 927, 1236, 1545, 1854, 5263])
...
while global_step < STEPS:
    for batch in dl:
        ...
        with autocast(device_type='cuda', enabled=(device=="cuda"), dtype=torch.float32):
            ...
            loss_total = 0.1 * loss + loss_color + loss_stable
