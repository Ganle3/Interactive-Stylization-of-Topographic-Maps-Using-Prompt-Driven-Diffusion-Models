...
OUTDIR  = r"D:\Junyhuang\Project2\Outputs_20prompts_styling_32ctrl_8unt"
...
SAVE_IMG_EVERY = 30000    # steps for visualization
...
wrapped = lora_qkv(model.model.diffusion_model, r_q=8, r_kv=LORA_R)
...
split_paths = stratified_split_ratio(
    JSONL, SPLIT_DIR, per_prompt_ratio=(0.98, 0.00, 0.02),
...
ds_val = Subset(ds_base, [0, 349, 618, 927, 1236, 1545, 1854, 3263])
